...
import { useEvent, ErrorsContext, EventContext, PropertiesPanelContext } from '@bpmn-io/properties-panel';
// import { Description, Tooltip } from '@bpmn-io/properties-panel/src/components';
