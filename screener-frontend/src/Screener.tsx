...
export default function Screener() {
  ...
  const [screenerResource] = createResource<Screener>(() => fetchScreenerData(params.screenerId));
  ...
  return (
    <>
      <div class="mt-4">
        ...
        >
          {screenerResource.loading && <Loading></Loading>}
          {screenerResource() && (
            <div class="flex flex-col lg:flex-row">
              <div class="flex-1 overflow-y-auto p-4">
                <FormRenderer
                  schema={screenerResource()?.formSchema || {}}
