...
public class DecisionServiceInvoker {
    ...
    public static Object invoke(String modelName, String serviceName,
        ...
        // Get the CDI instance - note that this requires the CDI container to be running
        DecisionServiceInvoker invoker = null;
        try {
            invoker = Arc.container().select(DecisionServiceInvoker.class).get();
        } catch (Exception e) {
        ...
        if (invoker == null || invoker.application == null) {
            throw new RuntimeException("DecisionServiceInvoker not properly initialized. " +
                "The Application instance was not injected.");
        }
     ...
     */
    private Map<String, String> getKnownModels() {
        ...
        known.put("Enrollment", "https://kie.apache.org/dmn/_6E9D53A6-E99A-4060-9E3E-1AE12EAB5465");
